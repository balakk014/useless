	...
	<div class="footer_top_out">
		<div class="inner">
			<div class="mob_support">
				...
				<ul>
					<li><a href="<?php echo COMMON_IOS_PASSENGER_APP; ?>" target="_blank"><img alt="ios" src="<?php echo URL_BASE; ?>public/logged_in/images/ios.png"/></a></li>
					<li><a href="<?php echo COMMON_ANDROID_PASSENGER_APP; ?>" target="_blank"><img alt="android" src="<?php echo URL_BASE; ?>public/logged_in/images/android.png"/></a></li>
				</ul>
			</div>
		...
		<div class="inner">
			<div class="footer">
				...
				<div class="footer_products">
					...
					<p>1159 Sonora Court,</p>
					<p>Suite 204, Sunnyvale,</p>
					<p>CA 94086, United States.</p>
...
function subscribe_validation()
{
	...
	if (email == "") {
		$("#subscribe_email_error").html("Enter Your Email-ID")
	} else if (!validate_result) {
		$("#subscribe_email_error").html("Invalid Email")
	} else {
