...
<script type="text/javascript" src="<?php echo URL_BASE;?>public/logged_in/js/scale.fix.js"></script>
<script type="text/javascript" src="<?php echo URL_BASE;?>public/logged_in/js/jquery.formance.min.js"></script>
<script type="text/javascript" src="<?php echo URL_BASE;?>public/logged_in/js/awesome_form.js"></script>
<div class="signup_form" style="display:none">
	...
	<form name="signupForm" method="post" enctype="multipart/form-data">
		...
		<ul>
			...
			<li><div class="full_name"><input type="text" tabindex="1" on-paste="return false;" name="email" maxlength="50" value="<?php if($session->get("signup_data") == 2) { echo $session->get("fb_email"); } ?>" placeholder="<?php echo __('email'); ?>*"/></div></li>
			...
			<li><div class="full_name"><input type="password" tabindex="3" name="confirm_password" maxlength="24" value="" placeholder="<?php echo __('confirm_password_label'); ?>*"/></div></li>
			 <li><div class="full_name_mobile"><span><input type="text" tabindex="4" class="country_code_restrict" maxlength="5" name="country_code" value="" placeholder="+962*"/></span><div class="mob_no"><input type="text" name="mobile_number" tabindex="5" class="txtboxToFilter" maxlength="15" value="" placeholder="<?php echo __('mobile_number'); ?>*"/></div></div><em id="signup_code_phone_error"></em></li>
			...
			<li><p>By clicking "Create Account", you agree to GetUpTaxi<br>
