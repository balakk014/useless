...
<?php $session = Session::instance(); ?>
		...
		<ul>
			<li>
				<div class="full_name_mobile">
					<span>
						<input type="text" class="country_code_restrict" tabindex="1" onpaste="return false;" title="Country Code" name="country_code" value="<?php if(isset($_COOKIE["country_code"])) { echo $_COOKIE["country_code"]; } ?>" placeholder="+962*" maxlength="5"/>
					</span>
					<div class="mob_no">
						<input type="text" name="mobile_number" tabindex="2" class="txtboxToFilter" value="<?php if(isset($_COOKIE["mobile_number"])) { echo $_COOKIE["mobile_number"]; } ?>" onpaste="return false;" maxlength="15" placeholder="9876543210*" title="<?php echo __('mobile_number'); ?>"/>
					</div>
				</div>
	...
	<div class="new_acc_create">
		...
		<label>&nbsp;</label>
		<a onclick="facebookconnect_login();" href="javascript:;"><img alt="facebook" src="<?php echo URL_BASE;?>public/logged_in/images/facebook.png"/></a>
	</div>
</div>
