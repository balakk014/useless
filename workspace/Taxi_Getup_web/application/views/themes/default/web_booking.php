...
<script src="<?php echo URL_BASE."public/logged_in/js/map.js"; ?>"></script>
	...
	<div class="inner">
		...
		<div class="banner_tab general_tab_outer">
			...
			<div class="taxi_tab_images car_img">
				<?php /*<div class="tab_1"><img alt="taxi image" src="<?php echo URL_BASE; ?>public/logged_in/images/taxi_big.png"/></div>
				<div class="tab_2" style="display: none;"><img alt="SUV image" src="<?php echo URL_BASE; ?>public/logged_in/images/suv_big.png"/></div>
				<div class="tab_3" style="display: none;"><img alt="LUX image" src="<?php echo URL_BASE; ?>public/logged_in/images/lux_big.png"/></div> */ ?>
				<?php 
				if(count($getmodel_details) > 0) {
					$tabId = 1;
					foreach($getmodel_details as $models){
...
<!-- map start -->
<div class="google_map" id="map-canvas" style="width:100%;height:503px;margin:0;"><?php /*<img alt="google map" src="<?php echo URL_BASE; ?>public/web_booking/images/map_img.jpg"/> */ ?></div>
<!-- map end -->
<div id="fade"></div>
<div id="show_user_message">
    <div class="message_for_user_purpose">
        <h1><?php echo __('dont_refresh_message'); ?></h1>
        <img width="32" height="32" alt="loader" src="<?php echo URL_BASE;?>public/images/loading.gif"/>
    </div>
</div>
...
<script type="text/javascript">
	...
	function initMap()
	{
		...
		function  do_something(coords)
		{
			...
			var map = new google.maps.Map(document.getElementById('map-canvas'), {
				center: {lat: coords.latitude, lng: coords.longitude, city:coords.ci},
				zoom: 6
			}); */
		...
		var autocomplete = new google.maps.places.Autocomplete(document.getElementById('pickup_location'), options);
	...
	function fare_estimate()
	{
		...
		if(pickup_location != "" && drop_location != "") {
			...
			var geocodingAPI = "https://maps.googleapis.com/maps/api/geocode/json?latlng="+drop_latitude+","+drop_longitude+"&key=<?php echo GOOGLE_MAP_API_KEY; ?>";
			var city;
			$.getJSON(geocodingAPI, function (json) {
				...
				show_fare(city,pickup_location,drop_location,modelID,modelName);
			});
		} else {
	...
	function show_fare(city,pickup_location,drop_location,modelID,modelName)
	{
		$.ajax({
			url: "<?php echo URL_BASE;?>users/fare_estimate",
			type: "post",
			data: "city_name="+ city +"&pickup_location="+ pickup_location +"&drop_location="+ drop_location +"&modelID="+ modelID,
			beforeSend:function() {
				$("#trip_estimate_distance, #trip_estimate_fare,#modelImg,#model_name_lbl").html('<img src="<?php echo URL_BASE."public/logged_in/images/loading.gif"; ?>" alt="Loading..."/>');
			},
			success:function(data) {
...
if($global_session->get('set_map_marker') != "") { 
	//$ipAddress = "103.244.10.56";
	//$ipAddress = "203.223.189.94";
	...
	$handle = fopen($my_file, 'wb') or die('Cannot open file:  '.$my_file); 
	 ...
	 // here is issue by sureshkumar.m
	if(isset($map_result)) {
...
<div class="fare_estimate_popup" style="display: none;">
	...
	<div class="fare_estimation_details">
		<ul>
			...
			<li id="couldnot_find_address" style="display:none;">
				<em><?php echo __('coul_not_find_address'); ?></em>
			</li>
		</ul>
