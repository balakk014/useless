 ...
 <tr>
                        ...
                        <td width="20%" >
                            <div class="ser_input_field">
                                <input type="text" name="keyword" maxlength="256" style="width:100%;" id="keyword" value="<?php echo isset($srch['keyword']) ? trim($srch['keyword']) : ''; ?>" />
                            </div>
		...
		<div style="width:auto; float:right; margin:0 0;"> <?php if($countDriverRequests > 0){ $export_table_count = $countDriverRequests; include_once(APPPATH.'views/admin/export_menu.php'); } ?><?php //echo $export_excel_button; ?></div>
		</div>
		</div>     
...
<?php if ($countDriverRequests > 0) { ?>
		<thead>
		    <tr >
				...
				<td align="center" width="13%"><?php echo __('request_status'); ?></td>
		    </tr>
		</thead>
        <tbody>
		<?php
	...
	<tr class="<?php echo $trcolor; ?>">
		...
		<td align="center">
			<?php if($req_list['request_status'] == 1) { ?>
		...
		<td align="left"><a title="<?php echo ucfirst($req_list['driverName']); ?>" href="<?php echo URL_BASE.'manage/driverinfo/'.$req_list['driver_id'];?>"><?php echo $req_list['driverName']; ?></a></td>
		<td align="left"><?php echo $req_list['driverPhone']; ?></td>
		<?php if($_SESSION['user_type'] =='A') { ?>
		<td align="left"><?php echo ($req_list['company_name'] != '') ? $req_list['company_name'] : 'All'; ?></td>
		<?php } ?>
		<td align="left"><?php echo $req_list['wallet_request_amount']; ?></td>
		<td align="left"><?php echo Commonfunction::getDateTimeFormat($req_list['wallet_request_date'],1); ?></td>
		<td align="left"><?php echo ($req_list['request_status'] == 2 && $req_list['approved_date'] != '0000-00-00 00:00:00') ? Commonfunction::getDateTimeFormat($req_list['approved_date'],1) : '-'; ?></td>
			...
			<li>
                ...
                <span class="more_selection">
                    <select name="more_action" id="more_action">
                        ...
                        <option value="approve" ><?php echo __('Approve'); ?></option>
	...
	$('#more_action').change(function() {
		...
		var selected_val= $('#more_action').val();
			...
			switch (selected_val){
					...
					//=========================
					case "disapprove":
						var confirm_msg =  "<?php echo __('Are you sure want to disapprove Request(s)?');?>";
						//Find checkbox whether selected or not and do more action
						//============================================================
						if($('input[type="checkbox"]').is(':checked'))
						{
