...
<div class="container_content fl clr">
	...
	<?php 
		if(isset($company_details[0]['name'])){
	...
	<div class="new_input_field">
              <input type="text"  maxlength="30" minlength="4"  title="<?php echo __('enterfirstname'); ?>" id="firstname" name="firstname" value="<?php echo $firstname; ?>" />
              <?php if(isset($errors) && array_key_exists('firstname',$errors)){ echo "<span class='error'>".ucfirst($errors['firstname'])."</span>";}?>
	</div>
	</td>   	
	</tr>
	<?php 
		if(isset($company_details[0]['lastname'])){
	...
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="30" minlength="1" title="<?php echo __('enterlastname'); ?>" id="lastname" name="lastname" value="<?php echo $lastname; ?>" />
              <?php if(isset($errors) && array_key_exists('lastname',$errors)){ echo "<span class='error'>".ucfirst($errors['lastname'])."</span>";}?>
	</div>
	</td>   	
	</tr>
	<?php 
		if(isset($company_details[0]['email'])){
	...
	<td>
	<div class="new_input_field">
              <input type="text"  title="<?php echo __('enteremailaddress'); ?>" id="email" name="email" value="<?php echo $email; ?>" maxlength="100" /><br>
              <?php if(isset($errors) && array_key_exists('email',$errors)){ echo "<span class='error'>".ucfirst($errors['email'])."</span>";}?>
	</div>
	</td>   	
	</tr>
	<?php 
		if(isset($company_details[0]['org_password'])){
	...
	<?php 
		if(isset($company_details[0]['org_password'])){
			...
			if(isset($postvalue['password'])){
				$org_password = $postvalue['password'];
			}else{
				$org_password = "";
			}
		}
   ...
   <td>
		<div class="new_input_field">
		  <input type="password" title="<?php echo __('entertheconfirmpassword'); ?>" name="repassword" id="repassword" value="<?php echo $org_password; ?>"  minlength="2" maxlength="30" />
		  <?php if(isset($errors) && array_key_exists('repassword',$errors)){ echo "<span class='error'>".ucfirst($errors['repassword'])."</span>";}?>
	   </div>
	</td>   	
   </tr>
<?php 
		if(isset($company_details[0]['gender'])){
	...
	<?php 
		if(isset($company_details[0]['dob'])){
			$dob = $company_details[0]['dob'];
		}else{
			if(isset($postvalue['dob'])){
				$dob = $company_details['dob'];
			}else{
				$dob = "";
			}
		}
	...
	<?php 
		if(isset($company_details[0]['driver_license_id'])){
	...
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="30"  title="<?php echo __('enter_driver_license_id'); ?>" id="driver_license_id" name="driver_license_id" value="<?php echo $driver_license_id; ?>" />
	...
	<?php 
		if(isset($company_details[0]['driver_license_expire_date'])){
	...
	if(isset($driver_info_details[0]['driver_license_expire_date'])){
	...
	/*
	if(isset($driver_info_details[0]['driver_pco_license_number'])){
	...
	*/
	if(isset($driver_info_details[0]['driver_pco_license_expire_date'])){
	...
	if(isset($driver_info_details[0]['driver_insurance_number'])){
	...
	if(isset($driver_info_details[0]['driver_insurance_expire_date'])){
	...
	if(isset($driver_info_details[0]['driver_national_insurance_number'])){
	...
	if(isset($driver_info_details[0]['driver_national_insurance_expire_date'])){
	...
	if(isset($driver_info_details[0]['driver_twilio_number'])){
		$driver_twilio_number = $driver_info_details[0]['driver_twilio_number'];
	}else{
		if(isset($postvalue['driver_twilio_number'])){
			$driver_twilio_number = $postvalue['driver_twilio_number'];
		}else{
			$driver_twilio_number = "";
		}
	}	
	...
	*/ ?>
	<?php
	if(isset($company_details[0]['phone'])){
	...
	<tr>
	<td valign="top" width="25%"><label><?php echo __('twilio_number'); ?></label></td>        
	<td>
	<div class="new_input_field input-mob-box mobile_codetxt">
              <input type="text" title="<?php echo __('enter_twilio_number'); ?>" width="80%" id="driver_twilio_number" name="driver_twilio_number" value="<?php echo $driver_twilio_number; ?>" minlength="7" maxlength="20" />
              <?php if(isset($errors) && array_key_exists('driver_twilio_number',$errors)){ echo "<span class='error'>".ucfirst($errors['driver_twilio_number'])."</span>";}?>
	</div>
	</td>   	
	</tr>
   ...
   if(isset($company_details[0]['company_brand_type'])){
...
*/ ?>
 ...
 <?php
	if(isset($company_details[0]['company_id'])){
	...
	{ ?>
	 <?php
	if(isset($company_details[0]['login_country'])){
...
<tr>
	...
	<span><?php echo __('select_label'); ?></span>
	 ...
	 <?php
	if(isset($company_details[0]['login_state'])){
	...
	<div id="state_list">
	 ...
	 <?php
	if(isset($company_details[0]['login_city'])){
	...
	?>
	 <?php
	if(isset($company_details[0]['booking_limit'])){
	...
	<?php
	if(isset($company_details[0]['address'])){
...
//Brand Type change function
    var brand = '<?php echo isset($brand_type)?$brand_type:"M"; ?>';
		if(brand == "S"){
			$('#companyRow').hide();
		} else {
			$('#companyRow').show();
