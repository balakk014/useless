...
<div class="container_content fl clr">
    <div class="cont_container mt15 mt10">
	   ...
	   <td>
		   <div class="new_input_field">
			...
			<?php 
			if(isset($user_details[0]['lastname'])){
	   ...
	   <td>
		   <div class="new_input_field input-mob-box mobile_codetxt">
            ...
            <?php 
			if(isset($user_details[0]['address'])){
	...
	<?php $field_type =''; 
			...
			if(isset($user_details[0]['user_type'])){
	...
	<span><?php echo __('select_label'); ?></span>
              <select name="user_type" id="user_type">              
				  <option value="S" <?php if($field_type == 'S') { ?>Selected<?php } ?> >Moderator</option>
				  <option value="DA" <?php if($field_type == 'DA') { ?>Selected<?php } ?> >Demo Admin</option>
              </select>
        </div>
	</div>
...
<!--
	<tr>
	<?php $field_type =''; 
	if(isset($user_details[0]['login_state'])){
	...
	<tr>
	<?php $field_type =''; 
	if(isset($user_details[0]['login_city'])){
	...
	<td colspan="" class="star">*<?php echo __('required_label'); ?></td>
			...
			<td>&nbsp;</td>
                        <td colspan="">
							...
							<div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_editadmin" title="<?php echo __('submit' );?>" /></div>
