...
<thead>
	...
	<tr>
		...
		<td align="center" width="8%" ><?php echo 'Status'; ?></td>
		<td align="center" width="8%"><?php echo __('sno_label'); ?></td>
		<td align="left"  width="15%"><?php echo __('country_label'); ?></td>
		<td align="left"  width="15%"><?php echo __('state_label'); ?></td>
		<td align="left"  width="15%"><?php echo __('city_label'); ?></td>
		<td align="left"  width="20%"><?php echo __('city_model_fare'); ?></td>
	...
	<tbody>
        ...
        <tr class="<?php echo $trcolor; ?>">
			...
			<td align="left"><?php echo wordwrap(ucfirst($listings['country_name']),30,'<br/>',1); ?></td>
			<td align="left"><?php echo wordwrap(ucfirst($listings['state_name']),30,'<br/>',1); ?></td>
			<td align="left"><?php echo wordwrap(ucfirst($listings['city_name']),30,'<br/>',1); ?></td>
			<td align="left"><?php echo $listings['city_model_fare']; ?></td>
			<td align="center" width="20"><?php echo '<a href='.URL_BASE.'edit/city/'.$listings['city_id'].' " title ="Edit" class="editicon"></a>' ; ?></td>
		...
		?>
			<tr>
				<td colspan="8"></td>
				<td><div class="new_button"><input type="submit" name="update" value="<?php echo __('update');?>" /></div></td>
			</tr>   
		<?php }else { ?>
			<tr>
