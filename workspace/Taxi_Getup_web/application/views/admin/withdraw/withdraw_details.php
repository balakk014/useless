...
<div class="new_inner_page_outer">
	...
	echo ($details[0]['brand_type'] == 1) ? "Multy" : "Single";
    } else {
	echo '';
    } ?>
    			</p>
    			...
    			<div class="withdraw_input_fields">
					...
					<ul>
					    <li><select name="status" onchange="changeStatus(this.value);">
						    ...
						    <option value="2"><?php echo __('reject'); ?></option>
						</select>
			    ...
			    echo ucfirst($pay["payment_mode_name"]
				    ...
				    ?>
						...
						<em class='error' id="attachmentError"></em></li>
                                            <li><div class="new_button"><input type="submit" value="Submit" id="status_form_submit" name="status_form_submit" title="Submit"></div></li>
					</ul>
				    </form>
				    <?php
				} else {
					...
					$status = "Rejected";
				    } else if (isset($details[0]['request_status']) && $details[0]['request_status'] == 3) {
					$status = "Rejected";
				    }
				    echo "<p>".$status."</p>";
				}
		...
		<div class="withdraw_activity_log_list">
		    ...
		    <ul>
				<li>
				    ...
				    echo "Status changed to " . $status_label . ".";
				    $data = "";
				    if ($status == 1) {
					$data .= "<p>Payment Mode : " . $l["payment_mode_name"] . "</p>";
					$data .= "<p>Transaction ID : " . $l["transaction_id"] . "</p>";
					$data .= "<b>Comments </b> : " . $l["comments"];
				    } else if ($status == 2) {
					$data .= "<p><b>Reason </b> : " . $l["comments"]."</p>";
				    }
				    else if ($status == 3) {
					$data .= "<p><b>Reason </b> : " . $l["comments"]."</p>";
				    }
