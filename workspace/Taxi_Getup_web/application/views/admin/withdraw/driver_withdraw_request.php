            ...
            <li>
               <div class="withdraw_select">
                  <select name="status">
                     ...
                     <option <?php if (isset($srch['status']) && $srch['status'] == 0) { ?>selected<?php } ?> value="0"><?php echo __('Pending'); ?></option>
...
<div id="myModal" class="modal_popup" style="dispaly:none;">
            ...
            <ul>
               ...
               <li>
                  <select name="status" onchange="changeStatus(this.value);">
                     ...
                     <option value="2"><?php echo __('Cancelled'); ?></option>
                  </select>
