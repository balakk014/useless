...
<div class="container_content fl clr">
	<div class="cont_container mt15 mt10">
		<div class="content_middle">
			<form method="POST" class="form" name="frmusers" id="frmusers" action="coupon">
				<table border="0" cellpadding="5" cellspacing="0" width="100%">			
					...
					<tr>
						...
						<td colspan="">
							...
							<div class="new_button">   <input type="reset" onclick='window.location.href="<?php echo URL_BASE."add/coupon";?>"' value="<?php echo __('button_reset'); ?>" title="<?php echo __('button_reset'); ?>" /></div>
