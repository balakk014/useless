              ...
              <?php if(isset($errors) && array_key_exists('expire_date',$errors)){ echo "<span class='error'>".ucfirst($errors['expire_date'])."</span>";}?>
					...
					<tr>
						...
						<td colspan="">
							...
							<div class="new_button">   <input type="reset" onclick='window.location.href="<?php echo URL_BASE."edit/passenger_coupon/".$coupon_id;?>"' value="<?php echo __('button_reset'); ?>" title="<?php echo __('button_reset'); ?>" /></div>
