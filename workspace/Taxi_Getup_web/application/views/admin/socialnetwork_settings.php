       ...
       <div class="content_middle"> 
            <form method="POST" enctype="multipart/form-data" class="form" action="" >
                <table class="0" cellpadding="5" cellspacing="0" width="100%">
                    ...
                    <?php /*<tr>
                        <td valign="top" width="20%"><label><?php echo __('twitter_key'); ?></label><span class="star">*</span></td>   
                        <td><div class="new_input_field"><input type="text" name="twitter_key" id="twitter_key" title="<?php echo __('enter_twitter_key'); ?>" maxlength="50" value="<?php echo isset($socialsettings) && (!array_key_exists('twitter_key', $errors)) ? $socialsettings[0]['twitter_key'] : $validator['twitter_key']; ?>"></div>
                            <?php if(isset($errors) && array_key_exists('twitter_key',$errors)){ echo "<span class='error'>".ucfirst($errors['twitter_key'])."</span>";}?></td>
                    </tr>

                    <tr>
                        <td valign="top" width="20%"><label><?php echo __('twitter_secretkey'); ?></label><span class="star">*</span></td>   
                        <td><div class="new_input_field"><input type="text" name="twitter_secretkey" id="twitter_secretkey"  title="<?php echo __('enter_twitter_secretkey'); ?>" maxlength="100" value="<?php echo isset($socialsettings) && (!array_key_exists('twitter_secretkey', $errors)) ? $socialsettings[0]['twitter_secretkey'] : $validator['twitter_secretkey']; ?>"></div>
                            <?php if(isset($errors) && array_key_exists('twitter_secretkey',$errors)){ echo "<span class='error'>".ucfirst($errors['twitter_secretkey'])."</span>";}?></td>
                    </tr> */ ?>
                    <tr>
                        <td valign="top" width="20%"><label><?php echo __('facebook_share'); ?></label><span class="star">*</span></td>   
                        <td><div class="new_input_field"><input type="text" name="facebook_share" id="facebook_share" title="<?php echo __('enter_facebook_share'); ?>" maxlength="50" value="<?php echo isset($socialsettings) && (!array_key_exists('facebook_share', $errors)) ? $socialsettings[0]['facebook_share'] : $validator['facebook_share']; ?>"></div>
