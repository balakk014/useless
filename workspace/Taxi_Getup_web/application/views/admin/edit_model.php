...
<div class="container_content fl clr">
	...
	*/ ?>
	...
	<div class="new_input_field">
              <input type="text"  maxlength="30" minlength="2"  title="<?php echo __('entermodelname'); ?>" id="model_name" name="model_name" value="<?php echo isset($model_details[0]['model_name']) &&!array_key_exists('model_name',$postvalue)? trim($model_details[0]['model_name']):$postvalue['model_name']; ?>" />
              <?php if(isset($errors) && array_key_exists('model_name',$errors)){ echo "<span class='error'>".ucfirst($errors['model_name'])."</span>";}?>
	</div>
	</td>   	
	</tr>
	<?php 
		if(isset($model_details[0]['model_size'])){
	...
	<?php 
		if(isset($model_details[0]['base_fare'])){
	...
	<!--Fare Details start-->
	  <tr>
	   ...
	   <td></td>	          
	       ...
	       <td>			   
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enterthebase_fare'); ?>" class="required numbersdots" name="base_fare" id="base_fare" value="<?php echo $base_fare; ?>"  minlength="1" maxlength="30"  />
              <?php if(isset($errors) && array_key_exists('base_fare',$errors)){ echo "<span class='error'>".ucfirst($errors['base_fare'])."</span>";}?>
		   </div>
           </td>   	
           </tr>
           <?php 
			if(isset($model_details[0]['min_km'])){
				$min_km = $model_details[0]['min_km'];
			}else{
				if(isset($postvalue['base_fare'])){
					$min_km = $postvalue['base_fare'];
				}else{
					$min_km = "";
				}
			}
		   ...
		   <div class="new_input_field">
            ...
            <?php 
			if(isset($model_details[0]['min_fare'])){
           ...
           <?php 
			if(isset($model_details[0]['cancellation_fare'])){
		   ...
		   <div class="new_input_field">
            ...
            <?php 
			if(isset($model_details[0]['below_above_km'])){
	       ...
	       <td>			   
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enter_below_and_above_km'); ?>" class="required onlynumbers" name="below_and_above_km" id="below_and_above_km" value="<?php echo $below_above_km; ?>"  minlength="1" maxlength="7"  />
             ...
             <?php 
			if(isset($model_details[0]['below_km'])){
	       ...
	       <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('entertheabove_km'); ?>" class="required numbersdots" name="above_km" id="above_km" value="<?php echo $below_km; ?>"  minlength="1" maxlength="30"  />
              <?php if(isset($errors) && array_key_exists('above_km',$errors)){ echo "<span class='error'>".ucfirst($errors['above_km'])."</span>";}?>
		   </div>
           </td>   	
           </tr>  
              <?php 
			if(isset($model_details[0]['waiting_time'])){
	   ...
	   <td>
		   <div class="new_input_field">	
              <input type="text"  class="required numbersdots" title="<?php echo __('enterwaiting_charge'); ?>" id="waiting_time" name="waiting_time" value="<?php echo $waiting_time; ?>" minlength="1" maxlength="20" />
              <?php if(isset($errors) && array_key_exists('waiting_time',$errors)){ echo "<span class='error'>".ucfirst($errors['waiting_time'])."</span>";}?>
		   </div>
	   </td>   	
           </tr>  
            <?php 
			if(isset($model_details[0]['minutes_fare'])){
	   ...
	   <td>
		   <div class="new_input_field">	
              <input type="text"  class="required numbersdots" title="<?php echo __('enter_fare_per_minute'); ?>" id="minutes_fare" name="minutes_fare" value="<?php echo $minutes_fare; ?>" minlength="1" maxlength="6" />
              <?php if(isset($errors) && array_key_exists('minutes_fare',$errors)){ echo "<span class='error'>".ucfirst($errors['minutes_fare'])."</span>";}?>
		   </div>
	   </td>   	
           </tr> 
           <?php 
			if(isset($model_details[0]['taxi_speed'])){
           ...
           <tr>
			...
			<td>
			<div class="new_input_field">
					  <input type="text" title="<?php echo __('enter_taxi_speed'); ?>" class="required numbersdots validateZero" id="taxi_speed" name="taxi_speed" value="<?php echo $taxi_speed; ?>" minlength="1" maxlength="20" />
					  <?php if(isset($errors) && array_key_exists('taxi_speed',$errors)){ echo "<span class='error'>".ucfirst($errors['taxi_speed'])."</span>";}?>
			</div>
			</td>   	
			</tr>
            <?php 
			if(isset($model_details[0]['taxi_min_speed'])){
	       ...
	       <td>			   
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('entertaxi_min_speed'); ?>" class="required onlynumbers validateZero" name="taxi_min_speed" id="taxi_min_speed" value="<?php echo $taxi_min_speed; ?>"  minlength="1" maxlength="7"  />
            ...
            <?php 
			if(isset($model_details[0]['night_charge'])){
		...
		<div class="sec_tables" id="charge_det" <?php if($nc==1 || $nyt_charge==1){ ?> style="display:block;padding-left:0;" <?php }else if($nc==0 || $nyt_charge==0 || $nyt_charge==""){ ?> style="display:none;padding-left:5px;" <?php } ?>>
           <table border="0" cellpadding="5" cellspacing="0" width="100%">
			   <?php 
			if(isset($model_details[0]['night_timing_from'])){
	       ...
	       <td id="valid_from" style="display:none">
	         ...
	         <?php 
			if(isset($model_details[0]['night_timing_to'])){
	       ...
	       <td id="valid" style="display:none">
            ...
            <?php 
			if(isset($model_details[0]['night_fare'])){
	  ...
	  <!--Fare Details end-->
	   <?php 
			if(isset($model_details[0]['evening_charge'])){
	  ...
	  <!-- evening fare details start -->
       ...
       <div class="sec_tables" id="evening_charge_det" <?php if($efield_type==1){ ?> style="display:block;padding-left:5px;" <?php }else if($efield_type==0){ ?> style="display:none;padding-left:5px;" <?php } ?>>
			<table border="0" cellpadding="5" cellspacing="0" width="100%">
				<tr>
			   <td valign="top" width="20%"><label><?php echo __('evening_timing_from'); ?></label><span class="star">*</span></td>  <?php 
				if(isset($model_details[0]['evening_timing_from'])){
			   ...
			   <td valign="top" width="20%"><label><?php echo __('evening_timing_to'); ?></label><span class="star">*</span></td>  <?php 
				if(isset($model_details[0]['evening_timing_to'])){
			  ...
			  <td id="evening_valid_to" style="display:none">
			   ...
			   <?php 
				if(isset($model_details[0]['evening_fare'])){
	...
	<td colspan="" class="star">*<?php echo __('required_label'); ?></td>
			...
			<td class="empty_cell" width="20%">&nbsp;</td>
                        <td colspan="">
                            ...
                            <div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_editmodel" title="<?php echo __('submit' );?>" /></div>
...
$("#model_size" ).keyup(function() {
    ...
    $.validator.addMethod("validateZero", function(value, element) {
			...
			}, " Please enter the value greater than zero");
