...
$form_action = URL_BASE . 'manage/coupon/';
$back_action = URL_BASE . 'manage/coupon/';
?>
	...
	<div class="content_middle">
		...
		<table class="list_table1" border="0" width="100%" cellpadding="5" cellspacing="0">
			...
			if ($_SESSION['user_type'] == 'A') {
			    ?>  
    			<td valign="top"><label><?php echo __('coupon_status_label'); ?></label></td>
    			<td valign="top">
		...
		<div class="widget">
			...
			<div style="width:auto; float:right; margin: -5px 3px;">
			  <?php //  <div class="new_button"> <?php echo $export_excel_button; </div>        */ ?>               
			      <?php //<div class="new_button"> <?php echo $export_pdf_button; </div>      */ ?>                    
			</div>
		    </div>        
			<?php
			if ($total_users > 0) {
...
if ($total_users > 0) {
	...
	?>
					    ...
					    if ($couponcode_list['coupon_used'] == 0) {
						?>
	    				    <td align="center" width="20" colspan='3' ><?php echo '<a href=' . URL_BASE . 'edit/coupon/' . $couponcode_list['coupon_id'] . ' " title ="Edit" class="editicon"></a>'; ?></td>
						<?php
					    } else {
						?>
