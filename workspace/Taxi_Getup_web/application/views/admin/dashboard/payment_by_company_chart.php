...
$(function () {
	...
	$('#payment_by_company').highcharts({
		...
		series: [{
			data: [
				{ name: 'Trip Payment', y: <?php echo $total_amount; ?> ,x: <?php echo $payment_by_company[0]['total_amount_count']; ?>,color:'#0088cc' },
				{ name: 'Card Payment', y: <?php echo $card_payment; ?> ,x: <?php echo $payment_by_company[0]['card_payment_count']; ?>,color:'#f39c12' },
				{ name: 'Cash Payment', y: <?php echo $cash_payment; ?> ,x: <?php echo $payment_by_company[0]['cash_payment_count']; ?>,color:'#734ba9' },
				{ name: 'Promotional Payment', y: <?php echo round($payment_by_company[0]['promotional_amount'],2); ?> ,x: <?php echo $payment_by_company[0]['promotional_amount_count']; ?>,color:'#2baab1' },
				{ name: 'Referral Payment', y: <?php echo round($payment_by_company[0]['referral_payment'],2); ?> ,x: <?php echo $payment_by_company[0]['referral_payment_count']; ?>,color:'#cc0095' },
			]
		}]
	});
});
