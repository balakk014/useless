	...
	<td colspan="2"><h2 class="tab_sub_tit"><?php echo ucfirst(__('personalinform')); ?></h2></td>          
	   ...
	   <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enter_name'); ?>" name="name" id="name" value="<?php echo isset($login_detail[0]['name']) &&!array_key_exists('name',$postvalue)? trim($login_detail[0]['name']):$postvalue['name']; ?>"  minlength="4" maxlength="30" />
...
?>
	...
	<td valign="top" width="20%"><label><?php echo __('mobile'); ?></label><span class="star">*</span></td>        
	   <td>
		   <div class="new_input_field">	
              <input type="text"  maxlength="20" minlength="7"  title="<?php echo __('entermobileno'); ?>" placeholder="+1-888999999" id="phone" name="phone" value="<?php echo isset($login_detail[0]['phone']) &&!array_key_exists('phone',$postvalue)? trim($country_code.$login_detail[0]['phone']):$postvalue['phone']; ?>" />
	...
	<tr>
	<td valign="top" width="20%"><label><?php echo __('twilio_number'); ?></label></td>        
	<td>
	<div class="new_input_field input-mob-box mobile_codetxt">
              <input type="text" title="<?php echo __('enter_twilio_number'); ?>" width="80%" id="twilio_number" name="twilio_number" value="<?php echo isset($login_detail[0]['twilio_number']) &&!array_key_exists('twilio_number',$postvalue)? trim($login_detail[0]['twilio_number']):$postvalue['twilio_number']; ?>"" minlength="7" maxlength="20" />
              <?php if(isset($errors) && array_key_exists('twilio_number',$errors)){ echo "<span class='error'>".ucfirst($errors['twilio_number'])."</span>";}?>
	</div>
	</td>   	
	</tr>	
	   ...
	   <td>
		   <div class="new_input_field">
              <input type="text" title="<?php //echo __('enter_discounts_passenger'); ?>" class="required numbersdots numbersonly" name="discount" id="discount" value="<?php echo isset($login_detail[0]['discount']) &&!array_key_exists('discount',$postvalue)? trim($login_detail[0]['discount']):$postvalue['discount']; ?>" maxlength="4"  />
...
<?php if($_SESSION['user_type'] =='A' || $_SESSION['user_type'] =='DA')
	{ ?>		
	<tr>
	<?php $field_type =''; $field_type =  isset($login_detail[0]['passenger_cid']) &&!array_key_exists('company_name',$postvalue)? trim($login_detail[0]['passenger_cid']):$postvalue['company_name']; ?>
