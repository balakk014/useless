...
<div class="container_content fl clr">
	...
	<td></td>	          
	   ...
	   <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enterfirstname'); ?>" name="firstname" id="firstname" class="required" value="<?php echo isset($login_detail[0]['name']) &&!array_key_exists('firstname',$postvalue)? trim($login_detail[0]['name']):$postvalue['firstname']; ?>"  minlength="4" maxlength="30" />
	   ...
	   <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enterlastname'); ?>" name="lastname" class="required" id="lastname" value="<?php echo isset($login_detail[0]['lastname']) &&!array_key_exists('lastname',$postvalue)? trim($login_detail[0]['lastname']):$postvalue['lastname']; ?>" minlength="4"  maxlength="50" />
	...
	<td valign="top" width="20%"><label><?php echo __('email'); ?></label><span class="star">*</span></td>        
	   <td>
		   <div class="new_input_field">	
              <input type="text"  maxlength="30" minlength="3"  title="<?php echo __('enteremailaddress'); ?>" class="required email" id="email" name="email" value="<?php echo isset($login_detail[0]['email']) &&!array_key_exists('email',$postvalue)? trim($login_detail[0]['email']):$postvalue['email']; ?>" />
	...
	<td valign="top" width="20%"><label><?php echo __('mobile'); ?></label><span class="star">*</span></td>        
	   <td>
		   <div class="new_input_field input-mob-box mobile_codetxt">	
              <input type="text"  maxlength="30" minlength="7" class="required" title="<?php echo __('entermobileno'); ?>" id="phone" name="phone" value="<?php echo isset($login_detail[0]['phone']) &&!array_key_exists('phone',$postvalue)? trim($login_detail[0]['phone']):$postvalue['phone']; ?>" />
