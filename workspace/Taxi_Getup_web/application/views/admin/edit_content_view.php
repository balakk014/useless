...
<div class="container_content fl clr">
	...
	<tr>
            <td colspan="2"><h2 class="tab_sub_tit"><?php echo ucfirst(__('edit_content_view')); ?></h2></td>
	</tr>
	...
	<tr>
	    ...
	    <?php 
		if(isset($company_details[0]['meta_title'])){
	   ...
	   <td>
		<div class="new_input_field">
			<textarea name="meta_title" id="meta_title" title="<?php echo __('enter_meta_title'); ?>" rows="7" cols="35"><?php echo isset($company_details[0]['meta_title']) || !array_key_exists('meta_title',$postvalue)? trim($company_details[0]['meta_title']):$postvalue['meta_title'];  ?></textarea>
			<?php if(isset($errors) && array_key_exists('meta_title',$errors)){ echo "<span class='error'>".ucfirst($errors['meta_title'])."</span>";}?>
		   </div>
           </td>
           </tr>
        <?php 
		if(isset($company_details[0]['meta_keyword'])){
	   ...
	   <td>
		<div class="new_input_field2">
		 ...
		 <?php 
		if(isset($company_details[0]['meta_description'])){
	   ...
	   <td>
		<div class="new_input_field2">
            ...
            <?php 
		if(isset($company_details[0]['content'])){
