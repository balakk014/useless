...
<?php } else { echo "<div class='nodata'  style='padding:0px 10px 8px 0;'>".__('no_data')."</div></div>"; } ?>
		...
		<div class="widget">
			<div class="title">
				...
				<div style="width:auto; float:right; "><?php if($count_transaction_list > 0){ $export_table_count = $count_transaction_list; include_once(APPPATH.'views/admin/transaction_export_menu.php'); } ?></div>
			</div>
		</div>
