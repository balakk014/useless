...
*/ ?>
 <script type="text/javascript" src="<?php echo URL_BASE;?>public/bootstrap-3.2.0/vendor/bootstrap/js/enscroll-0.6.2.min.js"></script>
...
$('.table_body').enscroll({
    ...
    verticalHandleClass: 'handle3'
                ...
                var blog_height = $(window).height() - 228;
               $(".table_body").css({
                'height': blog_height
               // 'overflow-y': 'auto'
               })
