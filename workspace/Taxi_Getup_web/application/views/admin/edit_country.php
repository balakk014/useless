    ...
    <div class="cont_container mt15 mt10">
       <div class="content_middle"> 
         ...
         <table border="0" cellpadding="5" cellspacing="0" width="100%">          
			...
			<td>
				<?php 
					if(isset($company_details[0]['country_name'])){
			...
			<div class="new_input_field">
					  <input type="text"  maxlength="30" minlength="2"  title="<?php echo __('enterthecountryname'); ?>" id="country_name" name="country_name" value="<?php echo $country_name; ?>" />
			...
			<td>
				<?php 
					if(isset($company_details[0]['iso_country_code'])){
			...
			<td>
				<?php 
					if(isset($company_details[0]['telephone_code'])){
			...
			<td>
				<?php 
					if(isset($company_details[0]['currency_code'])){
			...
			<td>
				<?php 
					if(isset($company_details[0]['currency_symbol'])){
				...
				?>
			<div class="new_input_field">
					  <input type="text"  maxlength="5"  title="<?php echo __('enter_currency_symbol'); ?>" id="currency_symbol" name="currency_symbol" value="<?php echo $currency_symbol; ?>" />
							...
							<tr>
								...
								<td colspan="">
									<div class="new_button">     <input type="button" value="<?php echo __('button_back'); ?>" onclick="window.history.go(-1)" /></div>
                                                                        <div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_editcountry" title="<?php echo __('submit' );?>" /></div>
