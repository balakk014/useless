    ...
    <div class="cont_container mt15 mt10">
       <div class="content_middle"> 
			...
			<table class="0" cellpadding="5" cellspacing="0" width="100%">
				<tr>
					...
					<td>
						...
						<input type="text" class="required" title="<?php echo __('enter_menu_name_label'); ?>" name="menu_name" id="menu_name" value="<?php echo isset($model_details[0]['menu_name']) &&!array_key_exists('menu_name',$postvalue)? trim($model_details[0]['menu_name']):$postvalue['menu_name']; ?>" >					
			...
			<tr>
				...
				<td>
					<div class="new_input_field">
					<input type="text"  title="<?php echo __('enter_menu_name_label'); ?>" name="slug" id="slug" value="<?php echo isset($model_details[0]['menu_link']) &&!array_key_exists('slug',$postvalue)? trim($model_details[0]['menu_link']):$postvalue['slug']; ?>" class="slug">			
			...
			<tr>	
				<td width="20%">&nbsp;</td>
				<td>
                                    <div class="new_button">  <input type="submit" name="submit_editmenu" title ="<?php echo __('submit'); ?>" value="<?php echo __('submit'); ?>"></div>
