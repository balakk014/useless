...
<!-- time picker start-->
 ...
 <div class="container_content fl clr">
	...
	<table border="0" cellpadding="5" cellspacing="0" width="100%">                                                  
            ...
            <tr>
           <td valign="top" width="20%"><label><?php echo __('promo_type'); ?></label></td>        
	       <td>
		   <div class="new_input_field">
             <?php if($promocode_details[0]['promocode_type'] == 1) echo "All Passenger"; else if($promocode_details[0]['promocode_type'] == 2) { echo "Selected Passenger"; } else if($promocode_details[0]['promocode_type'] == 3){ echo "New Users"; } else { echo "--"; } ?>
              <input type="hidden" name="promocode_type" id="promocode_type" value="<?php echo isset($promocode_details[0]['promocode_type']) &&!array_key_exists('promocode_type',$postvalue)? trim($promocode_details[0]['promocode_type']):$postvalue['promocode_type']; ?>"  />
		   </div>
           </td>   	
           </tr>
           <tr>
           ...
           <?php 
			if(isset($promocode_details[0]['promo_discount'])){
		   ...
		   <div class="new_input_field">
            ...
            <?php 
			if(isset($promocode_details[0]['start_date'])){
           ...
           <?php 
			if(isset($promocode_details[0]['expire_date'])){
           ...
           <?php 
			if(isset($promocode_details[0]['promo_limit'])){
		   ...
		   <div class="new_input_field">
			...
			<?php if($promocode_details[0]['promocode_type'] != 3){ 
			...
			<td width="20%">&nbsp;</td>
                        <td colspan="">
							...
							<div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_addmodel" onclick = "return check_limit(); " title="<?php echo __('submit' );?>" /></div>
...
function check_limit()
{
 ...
 },"Expire time should be greater than current date time ");
