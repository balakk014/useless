			...
			<ul>
				<li class="color_code6">
					<div class="dash_active_left">
						<?php /* <a href="<?php echo URL_BASE ?>manage/taxisearch?keyword=&status=A" title="<?php echo __(strtoupper('taxis')); ?>" > </a> */ ?>
				...
				<li class="color_code7">
					<div class="dash_active_left">
						<?php /* <a href="<?php echo URL_BASE ?>manage/driversearch?keyword=&status=A" title="<?php echo __(strtoupper('Drivers')); ?>"></a> */ ?>
				...
				<li class="color_code8">
					<div class="dash_active_left">
						<?php /* <a href="<?php echo URL_BASE; ?>manage/today_unassigned_taxi" title="<?php echo __('unassigned_taxies'); ?>"> */ ?>
...
?></p>
	...
	<div class="dashborad_widget_box lg-12">
		...
		<div class="dashboard_widget_title with_calender">
		    <h2><?php echo __('Current Status of Driver'); ?></h2>
...
<?php if (SHOW_MAP != 1) { ?>
	<div class="live_trip_right_box">
				<ul>
					<li><span class="map_available">Available</span></li>
					<li><span class="map_ontrip">On Trip</span></li>
					<li><span class="map_inactive">In Active</span></li>
					 <li><span class="map_shiftout">Shift out</span></li>
				</ul>
			</div>
...
<?php } ?>
	...
	<div class="dashborad_widget_box lg-12">
		...
		<div class="dashboard_map_outer" id="company_total_trips_details">
		    <div id="company_trips_details"></div>
		</div>
	    </div>
	</div>
    </div>
	...
	<div class="dashborad_widget_box lg-12">
		...
		<div class="dashboard_calender_in_header with_select_box">
			...
			<li>
			    <div class="new_dash_calender_input">
				<input type="text"  readonly title="<?php echo __('select_datetime'); ?>"  id="userstartdate" name="userstartdate" value="<?php if (isset($postvalue) && array_key_exists('userstartdate', $postvalue)) {
			echo $postvalue['userstartdate'];
		    } ?>"  />
			...
			<li>
			    <div class="new_dash_calender_input">
				<input type="text"  readonly title="<?php echo __('select_datetime'); ?>"  id="userenddate" name="userenddate" value="<?php if (isset($postvalue) && array_key_exists('userenddate', $postvalue)) {
			echo $postvalue['userenddate'];
		    } ?>"  />
				<span id="enddate_error" class="errors" style="display:none;"></span>
			    </div>
			</li>
			<li><input type="button" name="change_usercompany" id="change_usercompany" value="GO" title="Go" ></li>
		    </ul>
		</div>
