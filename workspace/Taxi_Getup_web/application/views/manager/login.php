...
<div class="loginWrapper">
    ...
    <div class="loginLogo">	
     ...
     <a href="<?php echo URL_BASE; ?>" target = "_blank"><img src="<?php echo URL_BASE . SITE_LOGO_IMGPATH . 'logo.png'; ?>" /></a>
	   </div>   
...
<?php if(isset($errors) && array_key_exists('password',$errors)){ echo "<span class='error'>".ucfirst($errors['password'])."</span>";}?>
                ...
                <div class="loginControl">
                    <div class="rememberMe"><a href="<?php echo URL_BASE; ?>manager/forgot_password" class="frgtpsd"><?php echo __('forgot_password'); ?></a></div>
