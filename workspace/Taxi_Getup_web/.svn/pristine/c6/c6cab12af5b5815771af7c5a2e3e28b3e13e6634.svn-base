...
<div class="header_outer_cont">
            <div class="header_outer_inner clearfix">
                <div class="logo">                
                    <h1><span id="current_time" style="display:none;"></span>                  	
                        ...
                        <a href="<?php echo URL_BASE; ?>" title="Getuptaxi" ><img src="<?php echo URL_BASE; ?>public/uploads/site_logo/logo.png" ></a>
                                            </h1>
                </div>
			...
			<!-- Taximobility Design-->
							...
							<li ><a href="http://www.getuptaxi.com/" title="demo">Demo</a></li>
	...
	<div class="error404_sec">
		<div class="center">
			...
			<div class="error404_info_block">
				...
				<a class="error404_link" title="Getuptaxi" href="<?php echo URL_BASE;?>"><?php echo URL_BASE;?></a>
			</div>
		</div>
	</div>
        ...
        <div class="footer clearfix">
            <div class="clearfix">
                    ...
                    <div class="footer_products footer_rgt">
                        ...
                        <p class="copy_r">©2014 Getuptaxi. All rights reserved.</p>
        </div>
    </div>
                            ...
                            <div class="popup_txtbox shownn_label">
                                <div id="code">
                                    <div class="fl">
                                        ...
                                        <div class="chgcapchafont"><p id="chgcapcha" style="text-transform:lowercase;" >mkusc                                            </p><img src="<?php echo URL_BASE; ?>public/images/reload.png" width="28px" height="28px" alt="" id="refresh" 
