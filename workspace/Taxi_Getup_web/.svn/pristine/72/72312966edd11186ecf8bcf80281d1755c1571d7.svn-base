...
<div class="loginWrapper">
    ...
    <?php if($controller == 'company') { ?>
     <div style="width:200px;margin-left:65px;" align="center">
        ...
        <div style="float:right"><a href="<?php echo URL_BASE; ?>manager/login" target = "_self">Manager Login</a> </div>
     </div>
	<?php } ?>
...
<?php if(isset($errors) && array_key_exists('password',$errors)){ echo "<span class='error'>".ucfirst($errors['password'])."</span>";}?>
                ...
                <div class="loginControl">
                    <div class="rememberMe"><a href="<?php echo URL_BASE; ?>admin/forgot_password" class="frgtpsd"><?php echo __('forgot_password'); ?></a></div> 
