                  ...
                  <div class="widget" style="margin-bottom:0px !important;">
                        <div class="title"><h6><?php echo $page_title; ?></h6>
                            <div style="width:auto; float:right;">
                                <?php  if($total_users > 0){ $export_table_count=count($all_list); include_once(APPPATH.'views/admin/export_menu.php'); }?> <?php //echo $export_excel_button; ?></div>                       
...
<?php if ($total_users > 0) { ?>
		<thead>
		    <tr>
				...
				<td align="left" style="text-align:left;" width="20%"><?php echo __('Add Wallet Amount'); ?></td>
	...
	<tr class="<?php echo $trcolor; ?>">
		...
		<td><a title="<?php echo ucfirst($listings['name']); ?>" href="<?php echo URL_BASE.'manageusers/add_passenger_credits/'.$listings['id'];?>"><img src="<?php echo URL_BASE."public/images/add_wallet_money.png" ?>"></a></td>
		...
		<td align="center" colspan='3' ><?php echo '<a href='.URL_BASE.'admin/editpassenger/'.$listings['id'].' " title ="Edit" class="editicon"></a>' ; ?></td>
