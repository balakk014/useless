...
<?php if ($total_users > 0) { ?>
		...
		<td align="left"  width="12%"><?php echo ucfirst(__('name')); ?></td>
		<td align="left"  width="12%"><?php echo ucfirst(__('lastname')); ?></td>
		...
		<td align="left"  width="15%"><?php echo __('created_date'); ?></td>
	...
	<tr class="<?php echo $trcolor; ?>">
		...
		<td><?php echo wordwrap(ucfirst($listings['lastname']),30,'<br/>',1); ?></td>
		<td><?php echo wordwrap($listings['email'],25,'<br />',1); ?></td>
		<td align="left"><?php echo wordwrap($listings['phone'],25,'<br />',1); ?></td>
