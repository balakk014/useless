    ...
    <div class="cont_container mt15 mt10">
	   ...
	   <td>
		   <div class="new_input_field input-mob-box mobile_codetxt">
              <input type="text" title="<?php echo __('entermobileno'); ?>" name="phone" id="phone" class="required" value="<?php if(isset($postvalue) && array_key_exists('phone',$postvalue)){ echo $postvalue['phone']; }?>" minlength="7" maxlength="20" />
...
*/ ?>
	...
	<?php /*<table cellpadding="5" cellspacing="0" width="100%">
		<tr>
	...
	<td colspan="" class="star">*<?php echo __('required_label'); ?></td>
					...
					<td width="20%" class=""> &nbsp;</td>
                        <td colspan="">
                            <div class="new_button"><input type="button" value="<?php echo __('button_back'); ?>" onclick="window.location='<?php echo URL_BASE."manage/company"; ?>'" /></div>
