...
<tr>
	...
	<td colspan="" class="star">*<?php echo __('required_label'); ?></td>
			...
			<td>&nbsp;</td>
                        <td colspan="">
                            <div class="new_button">     <input type="button" value="<?php echo __('button_back'); ?>" onclick="window.location='<?php echo URL_BASE."manage/manager"; ?>'" /></div>
                            <div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_addmanager" title="<?php echo __('submit' );?>" /></div>
