...
?>
<div id="company_revenue_chart" <?php if($no_data) { ?> style="min-width: 310px; height: auto; margin: 0 auto"<?php } ?>> <div class="nodata_found">No Data Found</div></div>
<?php if($no_data) { ?>
<?php
if(count($grpahdata) > 0) {
