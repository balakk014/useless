				...
				<div class="card_details">
					<form name="payment_option_form" method="post" autocomplete="off" onsubmit="return validate_payment_option_form();">
						<ul>
							...
							<li class="card_no">
								<input type="text" class="credit_card_number" x-autocompletetype="cc-number" placeholder="<?php echo __("credit_card_no"); ?>" name="creditcard_number" onpaste="return false;" value="<?php echo trim(chunk_split(encrypt_decrypt('decrypt',$card[0]["creditcard_no"]), 4, ' ')); ?>">
							...
							<li class="cal_month" style="margin-left: 0;">
								<input type="text" class="credit_card_expiry" x-autocompletetype="cc-exp" placeholder="<?php echo __("mm_yyyy"); ?>" maxlength="9" onpaste="return false;" name="creditcard_expiry_date" value="<?php echo $month_year; ?>">
