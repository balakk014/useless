...
$(function () {
	$('#assigned_unassigned_graph').highcharts({
		...
		series: [{
			data: [
				{ name: 'Total Taxies', y: <?php echo $taxi_count; ?>,color:"#0088cc"},
				{ name: 'Assigned Taxies', y: <?php echo $assigned_taxi_count; ?>,color:"#f39c12"},
				{ name: 'Total Drivers', y: <?php echo $total_driver_count; ?>,color:"#734ba9"},
				{ name: 'Assigned Drivers', y: <?php echo $assigned_driver_count; ?>,color:"#2baab1"},
			]
		}]
	});
});
