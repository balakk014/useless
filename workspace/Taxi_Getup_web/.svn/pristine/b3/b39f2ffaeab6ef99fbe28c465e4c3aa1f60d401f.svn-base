...
$form_action = URL_BASE.'manage/generated_coupon_list/';
$back_action = URL_BASE.'manage/generated_coupon_list/';
?>
			...
			{ 
				...
				{				 
					...
					<tr class="<?php echo $trcolor; ?>">
						...
						<td align="center"><?php echo '<a href='.URL_BASE.'manage/reprint_coupon?generate_id='.$value['generate_id'].' " title ="Print Coupon" class="btn btn-sm btn-info regenerate">Print Coupon</a>' ; ?></td>
						<?php }else{?>
						<td align="center">-</td>
						<?php } ?>
					</tr>
...
$(".regenerate").click(function(event){
    ...
    .done(function(data) {
    	...
    	if(response.status == 1)
    	{
      		...
      		window.location.href = URL_BASE+'manage/generated_coupon_list';
    	}
    	else
    	{
    		win.close();
