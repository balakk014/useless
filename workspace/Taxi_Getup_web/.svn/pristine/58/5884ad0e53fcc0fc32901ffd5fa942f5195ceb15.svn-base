...
$shift_status_val = isset($srch["shift_status"]) ? $srch["shift_status"] :''; 							
...
{ 
	...
	$export_excel_button='
        				...
        				onclick="location.href=\''.URL_BASE.'manage/export?keyword='.$keyword.'&status='.$status_val.'&shift_status='.$shift_status_val.'&type='.$user_type_val.'\'" />
    				';
}?>
...
<table class="list_table1" border="0" width="65%" cellpadding="5" cellspacing="0">
 <tr>
			...
			<div class="selector ser_input_field" id="uniform-user_type">
                        ...
                        <td valign="top"><label><?php echo __('enter_shift_status'); ?></label></td>
                        <td valign="top">
			<div class="selector ser_input_field" id="uniform-user_type">
                            <select class="select2" name="shift_status" id="shift_status" onchange="this.form.submit()">
                                <option value=""><?php echo __('select_label'); ?></option>    
                                <option value="IN" <?php if($shift_status_val == "IN") { ?>selected<?php } ?>><?php echo __('shift_in'); ?></option>
                                <option value="OUT" <?php if($shift_status_val == "OUT") { ?>selected<?php } ?>><?php echo __('shift_out'); ?></option>
                            </select>
                            </div>
                        </td>
		...
		<div style="width:auto; float:right; margin: 0;"> <?php if($total_company > 0){ $export_table_count=count($all_list); include_once(APPPATH.'views/admin/export_menu.php'); } ?><?php //echo $export_excel_button; ?></div>
		</div>
		</div>
...
<thead>
	<tr>
		...
		<td align="center" width="10%"><?php echo __('Account Balance'); ?></td>
		<td align="center" width="20%"><?php echo __('Add Account Balance'); ?></td>
		<td align="center" width="10%"><?php echo __('Trip Wallet'); ?></td>
		<td align="center" width="10%"><?php echo __('photo_label'); ?></td>
		<td align="center" width="10%"><?php echo __('driver_status'); ?></td> 
		<td align="center" width="10%"><?php echo __('last_update'); ?></td> 
...
<tbody>	
        ...
        <tr class="<?php echo $trcolor; ?>">
			...
			<td><a title="<?php echo ucfirst($listings['company_name']); ?>" href="<?php echo URL_BASE.'manage/companydetails/'.$listings['cid'];?>">
			 ...
			 <?php } ?>
			<td align="left"><?php echo $listings['phone']; ?></td>
			<td><?php echo $listings['driver_license_id']; ?></td>
			<td><?php echo CURRENCY.round($listings['account_balance'],2); ?></td>
			<td><a title="<?php echo ucfirst($listings['name']); ?>" href="<?php echo URL_BASE.'manageusers/add_driver_credits/'.$listings['id'];?>"><img src="<?php echo URL_BASE."public/images/add_wallet_money.png" ?>"></a></td>
			<td align="center"><?php $get_bal = Commonfunction::getDriverTripWallet($listings['id']);
							$get_bal = (isset($get_bal['tot_amount']))?$get_bal['tot_amount']:0;
						 ?>
				<a href="<?php echo URL_BASE; ?>manage/trip_balance_report?trip_keyword=<?php echo $listings['phone'];?>&trip_search_user=new"><?php echo CURRENCY.$get_bal; ?></a>			
				</td>
			...
			<td align="center"><?php echo $listings['update_date']; ?></td>
