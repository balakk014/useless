...
<div class="container_content fl clr">
	...
	<div class="new_input_field">
              ...
              <?php if(isset($errors) && array_key_exists('firstname',$errors)){ echo "<span class='error'>".ucfirst(__($errors['firstname']))."</span>";}?>
	</div>
	</td>   	
	</tr>
	...
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="30"  title="<?php echo __('enter_driver_license_id'); ?>" id="driver_license_id" name="driver_license_id" value="<?php if(isset($postvalue) && array_key_exists('driver_license_id',$postvalue)){ echo $postvalue['driver_license_id']; }?>" />
	...
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="30"  title="<?php echo __('enter_driver_pco_license_no'); ?>" id="driver_pco_license_number" name="driver_pco_license_number" value="<?php if(isset($postvalue) && array_key_exists('driver_pco_license_number',$postvalue)){ echo $postvalue['driver_pco_license_number']; }?>" />
	...
	*/ ?>
	...
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="30"  title="<?php echo __('enter_driver_insurance_no'); ?>" id="driver_insurance_number" name="driver_insurance_number" value="<?php if(isset($postvalue) && array_key_exists('driver_insurance_number',$postvalue)){ echo $postvalue['driver_insurance_number']; }?>" />
	...
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="30"  title="<?php echo __('enter_driver_national_insurance_no'); ?>" id="driver_national_insurance_number" name="driver_national_insurance_number" value="<?php if(isset($postvalue) && array_key_exists('driver_national_insurance_number',$postvalue)){ echo $postvalue['driver_national_insurance_number']; }?>" />
	...
	*/ ?>
	...
	<span><?php echo __('select_label'); ?></span>
		...
		<?php if($_SESSION['user_type']== 'C' || $_SESSION['user_type']== 'M' ) { ?> <input type="hidden" name="country" value="<?php echo $field_type; ?>"> <?php } ?>
        </div>
	</div>
