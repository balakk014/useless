...
<script>
	...
	var script = document.createElement('script');  
		script.src = "http://maps.googleapis.com/maps/api/js?key=<?php echo GOOGLE_MAP_API_KEY; ?>&amp;sensor=false&callback=initialize";
	...
	function initialize() 
	{
		...
		<?php } } $a++; } } ?>   
			...
			{
				$('#on_going_trip_map').html('<div class="nodata_found">No drivers found</div>');
			}
	}
</script>
