...
<div class="actions-wrapper">
	...
	<div id="quick-actions">
		...
		<li>
		    ...
		    <span class="rapid_title"><?php echo __(strtoupper('active users')); ?></span>
		</li>
		<li>
		    <div class="pink_bg">
			<div class="top-info">
		    ...
		    <span class="rapid_title"><?php echo __(strtoupper('active Companies')); ?></span>
		</li>
		<li>
		    <div class="blue_bg">
			<div class="top-info">
		    ...
		    <span class="rapid_title"><?php echo __(strtoupper('active company managers')); ?></span>
		</li>
		<li>
		    <div class="green_bg">
			<div class="top-info">
...
<script>
	...
	chartCompanyUser = new Highcharts.Chart({
	    ...
	    title: {
		text: 'Total users, grouped by company'
	    },
