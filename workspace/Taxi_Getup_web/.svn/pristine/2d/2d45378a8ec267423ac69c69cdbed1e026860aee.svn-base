...
<div class="container_content fl clr">
	...
	<tr>
	<?php $field_type =''; 
	if(isset($model_details[0]['city_stateid'])){
	...
	<?php
	if(isset($model_details[0]['city_name'])){
	...
	<?php
	if(isset($model_details[0]['zipcode'])){
	...
	<?php
	if(isset($model_details[0]['city_model_fare'])){
	...
	<td colspan="" class="star">*<?php echo __('required_label'); ?></td>
			...
			<td>&nbsp;</td>
                        <td colspan="">
							...
							<div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_editcity" title="<?php echo __('submit' );?>" /></div>
