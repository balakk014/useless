...
<div class="container_content fl clr">
		...
		<div class="content_middle">
			<div class="driverinfo_common">
					<h2 class="tab_sub_tit"><?php echo ucfirst(__('promoinform_label')); ?></h2>
                                        <ul>	
                                        <li>
                                                <label><?php echo ucfirst(__('promo_type')); ?></label>
                                                <p> <?php if($promo_data[0]['promocode_type'] == 1) echo "All Passenger"; else if($promo_data[0]['promocode_type'] == 2) { echo "Selected Passenger"; } else if($promo_data[0]['promocode_type'] == 3){ echo "New Users"; } else { echo "--"; } ?></p>
                                            </li>
                                            <li>
    ...
    echo '-';
                                 ...
                                 <?php
				if($promo_data[0]['promocode_type'] != 3){?>
                                            <li><label><?php echo __('passengers_count'); ?></label>
                                                <p><?php echo count(explode(",", $promo_data[0]['passenger_id'])); ?></p>
                                            </li>
...
<?php
					...
					if(isset($promo_data[0]['promo_used_details']) && $promo_data[0]['promo_used_details'] != "") {
						...
						foreach($data as $k => $c) {
							if($c > 0) {
								...
								$used_array[] = array("id" => $k,"name" => $name[0]["name"],"count" => $c);
								$used_count++;
							} else {
								$name = $commonmodel->get_passenger_name($k);
								$unused_array[] = array("id" => $k,"name" => $name[0]["name"],"count" => $c);
								$unused_count++;
							}
						}
					}
             ...
             <?php if($promo_data[0]['promocode_type'] != 3){ ?>
            <div class="over_all">
			<div class="widget" >
