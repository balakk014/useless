      ...
      <div class="widget">
         ...
         <div class= "overflow-block">
            <table cellspacing="1" cellpadding="10" width="100%" align="center" class="sTable responsive">
               ...
               <thead>
                  <tr>
                     <?php /* <td align="left" width="8%"><?php echo __('Select'); ?></td> */ ?>
               ...
               <tbody>
                  ...
                  <tr class="<?php echo $trcolor; ?>">
                     <?php /* <td align="center"><input type="checkbox" name="uniqueId[]" id="trxn_chk<?php echo $listings['trip_id'];?>" value="<?php echo $listings['transaction_id'].":".$listings['trip_id'];?>" />
                     </td> */ ?>
                     <?php /* </form>*/ ?>
