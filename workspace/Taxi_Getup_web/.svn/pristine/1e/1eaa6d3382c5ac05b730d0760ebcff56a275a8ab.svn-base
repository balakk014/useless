               ...
               <table cellspacing="1" cellpadding="10" width="100%" align="center" class="sTable responsive">
                  ...
                  <thead>
                     <tr>
                        ...
                        <td align="left" width="100"><?php echo __('motorcompanyname'); ?></td>
                  ...
                  <tbody>
                     ...
                     <tr class="<?php echo $trcolor; ?>">
                        ...
                        <td align="left" width="150"><a title="<?php echo ucfirst($listings['model_name']); ?>" href="<?php echo URL_BASE.'manage/modelinfo/'.$listings['model_id']; ?>"><?php echo isset($listings['model_name'])?wordwrap(ucfirst($listings['model_name']),30,'<br/>',1):wordwrap(ucfirst($listings['model_name']),30,'<br/>',1); ?></a></td>
                        <td align="left" width="200"><?php echo isset($listings['motor_name'])?wordwrap(ucfirst($listings['motor_name']),30,'<br/>',1):wordwrap(ucfirst($listings['motor_name']),30,'<br/>',1); ?></td>
                        <td align="center" width="20" colspan='3' ><?php echo '<a href='.URL_BASE.'edit/model/'.$listings['model_id'].' " title ="Edit" class="editicon"></a>' ; ?></td>
                     </tr>
                     <?php } 
                        } 
