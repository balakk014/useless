...
<thead>
	...
	<tbody>
		...
		<tr class="<?php echo $trcolor; ?>">
			...
			<td align="center"><?php echo '<a href='.URL_BASE.'edit/paymentgateway/'.$listings['id'].' " title ="Edit" class="editicon"></a>' ; ?></td>
		...
		?>
			<tr>
				...
				<td colspan="8" align="right"><div class="new_button"><input type="submit" name="update" value="<?php echo __('update');?>" /></div></td>
			</tr>   
		<?php }else { ?>
			<tr>
