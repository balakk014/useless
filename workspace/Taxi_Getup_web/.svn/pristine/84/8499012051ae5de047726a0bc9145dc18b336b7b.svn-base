...
<div class="container_content fl clr">
	...
	*/ ?>
	...
	<td>
	<div class="new_input_field">
              <input type="text" title="<?php echo __('enter_taxi_speed'); ?>" class="numbersdots" id="taxi_speed" name="taxi_speed" value="<?php if(isset($postvalue) && array_key_exists('taxi_speed',$postvalue)){ echo $postvalue['taxi_speed']; }?>" minlength="1" maxlength="20" />
	  ...
	  <tr>
	   ...
	   <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('entertaxi_min_speed'); ?>" class="numbersdots" name="taxi_min_speed" id="taxi_min_speed" value="<?php if(isset($postvalue) && array_key_exists('taxi_min_speed',$postvalue)){ echo $postvalue['taxi_min_speed']; }?>"    minlength="1" maxlength="20" />
	...
	<tr>
	   ...
	   <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enter_minimum_luggage'); ?>" class="onlynumbers" name="minimum_luggage" id="minimum_luggage" value="<?php if(isset($postvalue) && array_key_exists('minimum_luggage',$postvalue)){ echo $postvalue['minimum_luggage']; }?>" maxlength="4"  />
	...
	<span><?php echo __('select_label'); ?></span>
			...
			<?php if($_SESSION['user_type']== 'C' || $_SESSION['user_type']== 'M' ) { ?> <input type="hidden" name="country" id="country" value="<?php echo DEFAULT_COUNTRY; ?>"> <?php } ?>
        </div>
	</div>
	...
	<tr>
        ...
        <table border="0" cellpadding="5" cellspacing="0" width="100%">		
			...
			<tr>
				...
				<td colspan="2">
					<div class="new_button">     <input type="button" value="<?php echo __('button_back'); ?>" onclick="window.location='<?php echo URL_BASE."manage/taxi"; ?>'" /></div>
                                        <div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_addtaxi" id="submit_addtaxi" title="<?php echo __('submit' );?>" /></div>
