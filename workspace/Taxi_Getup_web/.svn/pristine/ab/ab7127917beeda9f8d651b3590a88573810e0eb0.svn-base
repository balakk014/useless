				...
				<div class="recharge_amount_det">
					...
					<div class="recharge_amounts">
						...
						<div class="enter_amount">
							<input type="text" id="txtboxToFilter" name="wallet_amount" placeholder="<?php echo __('enter_amount_between').' '.CURRENCY.WALLET_AMOUNT_1."-".CURRENCY.WALLET_AMOUNT_3; ?>" onpaste="return false;" />
				...
				<div class="payment_detail" style="display:none;">
					<div class="pay_tab">
						<ul class="paymentgateway_name">
							<li class="paymentgateway <?php if(DEFAULT_PAYMENT_GATEWAY_ID == 1) { ?>active<?php } ?>" id="paypal"><a class="paypal" href="javascript:;" title="<?php echo __("paypal"); ?>"><?php echo __("paypal"); ?></a></li>
						...
						<form id="walletForm" name="payment_details_form" onsubmit="return validate_details();" method="post" autocomplete="off">
							...
							<ul class="paymentgateway_fields">
								...
								<li class="name_on_card">
									<input type="text" class="user_name" name="creditcard_user_name" placeholder="<?php echo __("name_of_the_card"); ?>" onpaste="return false;"/>
