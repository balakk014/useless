...
<table class="list_table1" border="0" width="100%" cellpadding="5" cellspacing="0">
 <tr>
                         ...
                         <td width="8%" class="wid100" ><label><?php echo __('start_date'); ?></label></td>
			...
			<tr>
				<?php /* if($_SESSION['user_type'] =='A') { ?>
                   ...
                   <td></td><td></td>
                   <?php } */ ?>
					<td valign="middle" class="wid100" width="8%"><label><?php echo __('expire_date'); ?></label></td>
                    ...
                    <tr>
                        ...
                        <div class="ser_input_field">
                            <input type="text" name="keyword"  class="wids_100" maxlength="256" style="width:100%;" id="keyword" value="<?php echo isset($srch['keyword']) ? trim($srch['keyword']) : ''; ?>" />
                        </div>
                    </td>
                   
                    </tr>
                    <tr>
                        <td colspan="2" valign="middle" class="promo_rgt"><label><?php echo __('promo_type'); ?></label></td>
                        <td colspan="2" width="20%" >
                        <div class="ser_input_field">
                            <select name="promocode_type" id="promocode_type" style="width:240px;">

								<option value=""><?php echo __('All'); ?></option>
								<option <?php if(isset($srch['promocode_type'])  && $srch['promocode_type'] == 1 ) { echo "Selected"; } ?> value="1"><?php echo __('All Users'); ?></option>
								<option  <?php if(isset($srch['promocode_type'])  && $srch['promocode_type'] == 2 ) { echo "Selected"; } ?>  value="2"><?php echo __('Selected Passenger'); ?></option>
								<option  <?php if(isset($srch['promocode_type'])  && $srch['promocode_type'] == 3 ) { echo "Selected"; } ?>  value="3" ><?php echo __('New Users'); ?></option>
...
<?php if ($total_users > 0) { ?>
		...
		<td align="center" width="13%"><?php echo __('promo_type'); ?></td>
	...
	<tr class="<?php echo $trcolor; ?>">
		...
		<td align="center"><?php if($promocode_list['promocode_type'] == 1) echo "All Passenger"; else if($promocode_list['promocode_type'] == 2) { echo "Selected Passenger"; } else if($promocode_list['promocode_type'] == 3){ echo "New Users"; } else { echo "--"; } ?></td>
		...
		*/?>
		...
		<td align="center" width="20" colspan='3' ><?php echo '<a href='.URL_BASE.'edit/promocode/'.$promocode_list['passenger_promoid'].' " title ="Edit" class="editicon"></a>' ; ?></td>
...
$("#search_user_btn").click(function(){
	...
	if(expFrom != '' && expTo != '' && expTo < expFrom) {
		$('#exp_enddate_error').html("End date should be greater than start date");
		flag = false;
	}
	return flag;
});
