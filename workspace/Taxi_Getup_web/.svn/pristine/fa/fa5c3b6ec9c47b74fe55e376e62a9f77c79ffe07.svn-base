...
<div class="container_content fl clr">
	...
	<?php if(isset($_SESSION['user_type']) && ($_SESSION['user_type'] == 'A' || $_SESSION['user_type'] == 'S') ) { ?>
	   ...
	   <td>
		   <div class="new_input_field input-mob-box mobile_codetxt">
              <input type="password" title="<?php echo __('entermobileno'); ?>" name="password" id="password" value="<?php echo $password; ?>" minlength="7" maxlength="20" />
	...
	<td colspan="" class="star">*<?php echo __('required_label'); ?></td>
			...
			<td>&nbsp;</td>
                        <td colspan="">
                            ...
                            <div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_editmanager" title="<?php echo __('submit' );?>" /></div>
