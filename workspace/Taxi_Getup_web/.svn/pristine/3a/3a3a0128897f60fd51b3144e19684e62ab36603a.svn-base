...
<div class="container_content fl clr">
	...
	?>
	   ...
	   <td>
		   <div class="new_input_field">	
              <input type="text"  maxlength="30" minlength="4"  class="required" title="<?php echo __('enterfirstname_msg'); ?>" id="firstname" name="firstname" value="<?php echo $firstname; ?>" />
	...
	?>	
	   ...
	   <td>
		   <div class="new_input_field">	
              <input type="text"  maxlength="30" minlength="1" class="required" title="<?php echo __('enterlastname_msg'); ?>" id="lastname" name="lastname" value="<?php echo $lastname; ?>" />
	...
	?>	 
	   ...
	   <td>
		   <div class="new_input_field">	
              <input type="text"  title="<?php echo __('enteremailaddress'); ?>" class="required" id="email" name="email" value="<?php echo $email; ?>" maxlength="50" /><br>
	...
	?>	 
	   ...
	   <td>
		   <div class="new_input_field input-mob-box mobile_codetxt">	
              <input type="text" title="<?php echo __('entermobileno'); ?>" id="phone" name="phone" value="<?php echo $phone; ?>" minlength="7" maxlength="20" />
	...
	?>	 
	   ...
	   <td>
		   <div class="new_input_field">	
              <input type="text"  maxlength="30" minlength="4"  class="required" title="<?php echo __('enterthecompanyname_msg'); ?>" id="company_name" name="company_name" value="<?php echo $company_name; ?>" />
    ...
    <?php
	if(isset($company_details[0]['company_country'])){
...
<tr>
	...
	if(isset($company_details[0]['company_state'])){
	...
	if(isset($company_details[0]['company_city'])){
...
<tr>
	...
	<?php /* if($controller == "edit" && $action == "company") { ?>
     ...
     <?php } */ ?>
		...
		<tr>
		<?php $field_type =''; $field_type =  isset($company_details[0]['time_zone']) &&!array_key_exists('time_zone',$postvalue)? trim($company_details[0]['time_zone']):$postvalue['time_zone']; ?>
