		...
		<div id="wrapper">
			<div id="hd">
				<h1 id="openvbx-logo"><a href="" class="navigate-away">
					<span class="replace">Callcenter</span></a>
				</h1>
			</div><!-- #hd -->
						...
						<div class="yui-b">
							<div id="vbx-main">
								<div class="vbx-content-main">
									...
									<h1 class="error-title">Cannot install Callcenter <?php echo $config['version']; ?></h1>
									<p class="error-message">Callcenter requires PHP <?php echo MIN_PHP_VERSION; ?>.<br />
					This server is running <?php echo PHP_VERSION; ?>.</p>
									<p class="error-message">Please upgrade PHP or contact your hosting provider about upgrading your account. Installation requirements can be found in the <a href="http://openvbx.org/install/">Callcenter Install Guide</a>.</p>
			...
			<div id="ft">
			<p class="copyright">Callcenter &bull; <em>v</em><?php echo $config['version']; ?> &mdash; Powered by <a href="http://twilio.com/">Twilio Inc.</a> &bull; <a href="http://www.twilio.com/legal/tos">Terms</a> &bull; <a href="http://www.twilio.com/legal/privacy">Privacy</a></p>
			</div><!-- #ft -->
		</div><!-- #wrapper -->
	</div><!-- #doc3 -->
</body>
