    ...
    <div class="error_page">
        <div class="center">
            ...
            <div class="error404_info_block">
                <h1>Oops, you found a Missing Page</h1>
                <p>Sorry, but there was some problem finding the page you requested.</p>
                <a href="<?php echo URL_BASE; ?>" title="TaxiMobility">Back to Home</a>
            </div>
        </div>
    </div>
</body>
