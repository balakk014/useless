    ...
    <div class="cont_container mt15 mt10">
       <div class="content_middle">    
         ...
         <table border="0" cellpadding="5" cellspacing="0" width="100%">
           <?php 
		if(isset($company_details[0]['mapping_companyid'])){
...
<tr>
	...
	if(isset($company_details[0]['mapping_countryid'])){
	...
	<tr>
	<?php  $field_type =''; 
	if(isset($company_details[0]['mapping_stateid'])){
	...
	<tr>
		...
		if(isset($company_details[0]['mapping_cityid'])){
	...
	if(isset($company_details[0]['mapping_driverid'])){
	...
	<tr>
		...
		if(isset($company_details[0]['mapping_taxiid'])){
...
*/ ?>
	...
	<?php 
		if(isset($company_details[0]['mapping_startdate'])){
	...
	<?php 
		if(isset($company_details[0]['mapping_enddate'])){
	...
	<td colspan="" class="star">*<?php echo __('required_label'); ?></td>
			...
			<td>&nbsp;</td>
                        <td colspan="">
                            ...
                            <div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_editassigntaxi" title="<?php echo __('submit' );?>" /></div>
