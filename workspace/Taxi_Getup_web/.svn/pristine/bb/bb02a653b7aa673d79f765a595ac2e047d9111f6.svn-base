...
<div class="container_content fl clr">
    <div class="cont_container mt15 mt10">
	   ...
	   <td>
		   <div class="new_input_field input-mob-box mobile_no_field">
	...
	<span><?php echo __('select_label'); ?></span>
              <select name="user_type" id="user_type">              
				  ...
				  <option value="DA">Demo Admin</option>
              </select>
        </div>
	</div>
			...
			<td>&nbsp;</td>
                        <td colspan="">
                            ...
                            <div class="new_button">     <input type="button" value="<?php echo __('button_back'); ?>" onclick="window.history.go(-1)" /></div>
                             <div class="new_button">  <input type="submit" value="<?php echo __('submit' );?>" name="submit_addadmin" title="<?php echo __('submit' );?>" /></div>
