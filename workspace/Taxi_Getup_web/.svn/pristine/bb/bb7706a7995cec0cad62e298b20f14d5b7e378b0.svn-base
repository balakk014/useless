				    	...
				    	<div id="quick-actions">
				    		<ul class="statistics">
				    			<li>
									<div class="blue_bg">
										<div class="top-info">
											<a href="<?php echo URL_BASE?>manage/managersearch?keyword=&status=A" title="<?php echo __(strtoupper('company managers'));?>" class="purple-square"></a>
									...
									<span class="rapid_title"><?php echo __(strtoupper('company managers'));?></span>
				    			</li>
				    			<li>
									<div class="green_bg">
										<div class="top-info">
		...
		<div class="title">
			...
			<div class="title" align="right">
				<div class="one">
					 ...
					 <input type="text"  readonly title="<?php echo __('select_datetime'); ?>"  id="company_trips_startdate" name="company_trips_startdate" value="<?php echo Commonfunction::getDateTimeFormat($startdate,1); ?>"  />
					 <span id="company_trips_startdate_error" class="errors" style="display:none;"></span>
					 <span><?php echo __('enddate');?></span>
					 <input type="text"  readonly title="<?php echo __('select_datetime'); ?>"  id="company_trips_enddate" name="company_trips_enddate" value="<?php echo Commonfunction::getDateTimeFormat($enddate,1); ?>"  />
