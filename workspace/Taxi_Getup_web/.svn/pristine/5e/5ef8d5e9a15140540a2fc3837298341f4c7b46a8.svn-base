<div class="info notice">
	<p>There is a newer version of Callcenter available: Version <?php echo $latest_version; ?>. Please update Callcenter to get the latest feature and security updates and fixes.</p>
