...
<div class="container_content fl clr">
    <div class="cont_container mt15 mt10">
       <div class="content_middle ">    
	    ...
	    <tr>
			<td><h2 class="tab_sub_tit"><?php echo __('Personal information'); ?></h2></td>
	...
	<div id="taxicompany_list">
       ...
       <span class="sub_note">If you select more than "1", then it will generate mobile number added with random numbers</span>
        <tr>
