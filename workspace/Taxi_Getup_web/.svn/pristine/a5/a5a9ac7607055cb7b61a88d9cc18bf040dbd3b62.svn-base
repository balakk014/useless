...
<div class="container_content fl clr">
	...
	if(count($result) > 0)
		...
		$enddate  = date('Y-m-t 12:59:59'); $display="";?>
			 ...
			 <div class="rgt_field_det" align="right">
				<div class="small_field_det">
				 ...
				 <input type="text"  readonly title="<?php echo __('select_datetime'); ?>"  id="transstartdate" name="transstartdate" value="<?php echo Commonfunction::getDateTimeFormat($startdate,1); ?>"  />
				 <span id="tstartdate_error" class="errors" style="display:none;"></span>
                                </div>
                             <div class="small_field_det">
                                 <label><?php echo __('enddate');?></label>
				 <input type="text"  readonly title="<?php echo __('select_datetime'); ?>"  id="transenddate" name="transenddate" value="<?php echo Commonfunction::getDateTimeFormat($enddate,1); ?>"  />
		...
		<div class="widget margin-bottom" >
			<div class="title"><h6><?php echo __('Current Status of Taxi'); ?></h6>
		...
		<div class="widget margin-bottom">
			...
			<h6><?php echo __('Completed Journey'); ?></h6>
				...
				<?php if($count_taxi_logs_completed_transaction > REC_PER_PAGE) {  ?>
					...
					<div class="small_butt">
                                            <a class="export_me_menu" href="<?php echo URL_BASE; ?>manage/pdftaxiinfo/<?php echo $taxi_details[0]['taxi_id']; ?>"><?php echo __('button_pdf'); ?></a>
					</div>	
					<div class="small_butt">
					...
					<div class="small_butt">
	<a class="export_me_menu" href="<?php echo URL_BASE; ?>transaction/managertransaction_list/all/?taxiid=<?php echo $taxi_details[0]['taxi_id']; ?>&driver_id=All&passengerid=All&transaction_id=&startdate=&enddate=&payment_type=All&payment_mode=All&search_user=" ><?php echo __('view_all'); ?></a>
					</div>
					<?php }
				}
				else
