...
<?php } ?>
	...
	<div class="withdraw_seach">
		...
		<ul>
		    <li>
			<input type="text" placeholder="<?php echo __('keyword'); ?>" name="keyword" maxlength="256" value="<?php echo isset($srch['keyword']) ? trim($srch['keyword']) : ''; ?>" />
		    </li>
...
<?php if ($company_id == 0) { ?>
			...
			<?php if ($company_id == 0) { ?>
    			<?php /* <th align="left" width="15%"><?php echo __('brand_type'); ?></th> */ ?>
...
<?php } ?>
	...
	<?php if ($company_id == 0) { ?>
	    		<?php /*	<td><?php echo ($req_list['brand_type'] == 1) ? "Multy" : "Single"; ?></td> */ ?>
				...
				<td>
					...
					$color = "#F92E12";
				    } else if ($req_list['request_status'] == 3) {
