...
<head>
	<title>Install Callcenter</title>
...
<div id="install-container">
	<h1 id="openvbx-logo"><a href="<?php echo site_url() ?>/"><span class="replace">Callcenter</span></a></h1>
...
<!-- step 1 -->
					<div id="step-1" class="step next">
						...
						<div class="step-desc">
							<p>Callcenter requires a few things from your server before it can be installed.<br /> 
...
<!-- step 4 -->
					<div id="step-4" class="step next prev">
						...
						<p class="step-desc">Callcenter can send messages and notifications through email. Enter an E-Mail Address that you want to show up as the From address when Callcenter sends messages.</p>
						...
						<fieldset>
							<input type="hidden" name="step" value="4" />
								...
								<label for="iFromEmail">Notifications will come from
									...
									<span class="instruction">You'll be able to change this later in your Callcenter Settings.</span>
								</label>
...
<!-- step 5 -->
					<div id="step-5" class="step prev submit">
						...
						<p class="step-desc">You will use your account to login to Callcenter once this installation is complete.</p>
						...
						<fieldset>
							<input type="hidden" name="step" value="5" />
								...
								<label for="iAdminEmail">E-Mail Address
									...
									<span class="instruction">You will use this E-Mail Address to login to Callcenter</span>
								</label>
...
<!-- step 6 -->
					<div id="step-6" class="step">
						...
						<p class="step-desc">Thanks for choosing Callcenter, enjoy.</p>
