	...
	<div class="vbx-content-container">
		...
		<div class="application-container">
			<div class="application">
				<img class="app-icon" src="<?php echo ASSET_ROOT ?>/i/iphone-icon-58.png" alt="Callcenter for iPhone" />
				<h4 class="app-name">Callcenter for iPhone</h4>
				<p class="app-desc">Get the Callcenter iPhone app and be
...
<div id="dialog-email" style="display: none;" class="email dialog" title="Callcenter for iPhone Install">
